...
titanic.raw = read.csv(file.choose(),header=T)
...
rules <- apriori(titanic.raw, parameter = list(minlen=2, supp=0.005, conf=0.8), appearance = list(rhs=c("survived=0", "survived=1"), default="lhs"), control = list(verbose=F))
